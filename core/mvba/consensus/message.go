...
func NewProposal(Author core.NodeID, B *ConsensusBlock, Epoch int64, sigService *crypto.SigService) (*Proposal, error) {
	proposal := &Proposal{
		Author: Author,
		B:      B,
		Epoch:  Epoch,
...
func (c *Commitment) Module() string {
	return "consensus"
}
...
func (e *ElectShare) Module() string {
	return "consensus"
}
...
func (c *CoinShare) Module() string {
	return "consensus"
}
