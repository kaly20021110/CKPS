...
The file [settings.json](https://github.com/kaly20021110/CKPS/blob/main/benchmark/settings.json) located in [CKPS/benchmark](https://github.com/kaly20021110/CKPS/blob/main/benchmark) contains all the configuration parameters of the testbed to deploy. Its content looks as follows:
...
The Aliyun instances are orchestrated with [Fabric](http://www.fabfile.org/) from the file [fabfile.py](https://github.com/kaly20021110/CKPS/blob/main/benchmark/fabfile.py) (located in [CKPS/benchmark](https://github.com/kaly20021110/CKPS/tree/main/benchmark)) you can list all possible commands as follows:

The command `fab create` creates new Aliyun instances; open [fabfile.py](https://github.com/kaly20021110/CKPS/blob/main/benchmark/fabfile.py) and locate the `create` task:
...
## License
This software is licensed as [Apache 2.0](https://github.com/kaly20021110/CKPS/blob/main/LICENSE)