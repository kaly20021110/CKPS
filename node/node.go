...
import (
	"bft/mvba/config"
	"bft/mvba/core"
	ckps "bft/mvba/core/mvba/consensus"
	"bft/mvba/crypto"
	"bft/mvba/logger"
	"bft/mvba/mempool"
	"bft/mvba/pool"
...
func NewNode(
	...
	//step 5:invoke core
	err = ckps.Consensus(core.NodeID(nodeID), commitee, coreParameters, txpool, _store, sigService, commitChannel, loopbackchannel, connectChannel, mempool)
