...
def remote(ctx):
    ...
    bench_params = {
        ...
        'duration': 40,
        'rate': [1700],                    # tx send rate 4_000,5_000,6_000,7_000,8_000,9_000 ,9000,10000,11000,12000  #,1000,1500,2000,2500,3000,3500
...
@task
def download(ctx,node_instance=8,ts="2025-07-03v20-07-05"):
    ''' download logs '''
    try:
